...
var _user$project$Link$sbool = function () {
	var toBool = function (result) {
		var _p0 = result;
		if (_p0.ctor === 'Ok') {
			return _elm_lang$core$Result$Ok(
				_elm_lang$core$Native_Utils.eq(_p0._0, 1));
		} else {
...
var _user$project$Link$encodeLinks = function (links) {
		...
		return _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'id',
					_1: _elm_lang$core$Json_Encode$string(link.id)
				},
					{
					ctor: '_Tuple2',
					_0: 'title',
					_1: _elm_lang$core$Json_Encode$string(link.title)
				},
					{
					ctor: '_Tuple2',
					_0: 'url',
					_1: _elm_lang$core$Json_Encode$string(link.url)
				}
				]));
	};
	return A2(
		...
		_elm_lang$core$Json_Encode$list(
			A2(_elm_lang$core$List$map, encodeLink, links)));
};
var _user$project$Link$Link = F6(
	function (a, b, c, d, e, f) {
		return {id: a, title: b, url: c, excerpt: d, favorite: e, keep: f};
	});
var _user$project$Link$decodeLink = A7(
	_elm_lang$core$Json_Decode$object6,
	_user$project$Link$Link,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'item_id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'given_title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'given_url', _elm_lang$core$Json_Decode$string),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode_ops[':='], 'excerpt', _elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'favorite', _user$project$Link$sbool),
	_elm_lang$core$Json_Decode$succeed(false));
var _user$project$Link$decodeLinks = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['list']),
	_elm_lang$core$Json_Decode$dict(_user$project$Link$decodeLink));

var _user$project$Ports$deletedLinks = _elm_lang$core$Native_Platform.outgoingPort(
	'deletedLinks',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {
					...
					title: v.title,
					url: v.url,
					excerpt: (v.excerpt.ctor === 'Nothing') ? null : v.excerpt._0,
					favorite: v.favorite,
					keep: v.keep
				};
			});
...
var _user$project$Selector$update = F2(
						...
						model,
						{
							selected: A2(
								...
								_elm_lang$core$Maybe$oneOf(
									_elm_lang$core$Native_List.fromArray(
										[
											A2(findNext, _p3._0, model.links),
											_elm_lang$core$List$head(model.links)
										])))
						});
				}
			case 'Up':
							...
							if (_p4.ctor === '::') {
								if (_p4._1.ctor === '::') {
									...
									if (_elm_lang$core$Native_Utils.eq(
										...
										var _v6 = selected,
											_v7 = A2(_elm_lang$core$List_ops['::'], _p5, _p4._1._1);
										selected = _v6;
										list = _v7;
										continue findPrev;
									}
						...
						model,
						{
							selected: A2(
								...
								_elm_lang$core$Maybe$oneOf(
									_elm_lang$core$Native_List.fromArray(
										[
											A2(findPrev, _p6._0, model.links),
											_elm_lang$core$List$head(
											_elm_lang$core$List$reverse(model.links))
										])))
						});
				}
			case 'Keep':
				var update$ = F2(
					function (selected, _p7) {
						var _p8 = _p7;
						var _p10 = _p8._1;
						var _p9 = _p8._0;
						return _elm_lang$core$Native_Utils.eq(_p9, selected) ? {
							ctor: '_Tuple2',
							_0: _p9,
							_1: _elm_lang$core$Native_Utils.update(
								_p10,
								{
									keep: _elm_lang$core$Basics$not(_p10.keep)
								})
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('link__excerpt')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(excerpt)
						]))
				]));
	});
var _user$project$Selector$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Selector$linkItem(model.selected),
					model.links))
			]));
};
...
var _user$project$Selector$NoOp = {ctor: 'NoOp'};
var _user$project$Selector$keyToMsg = function (key) {
	var $char = _elm_lang$core$Char$fromCode(key);
	return _elm_lang$core$Native_Utils.eq(
		$char,
		_elm_lang$core$Native_Utils.chr('j')) ? _user$project$Selector$Down : (_elm_lang$core$Native_Utils.eq(
		$char,
		_elm_lang$core$Native_Utils.chr('k')) ? _user$project$Selector$Up : (_elm_lang$core$Native_Utils.eq(
		$char,
		_elm_lang$core$Native_Utils.chr(' ')) ? _user$project$Selector$Keep : _user$project$Selector$NoOp));
};
var _user$project$Selector$keyboard = _elm_lang$keyboard$Keyboard$presses(_user$project$Selector$keyToMsg);

var _user$project$Triage$authed = F4(
	function (verb, token, url, body) {
		return A2(
			...
			_evancz$elm_http$Http$defaultSettings,
			{
				...
				headers: _elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'token', _1: token}
					]),
				url: url,
				body: body
			});
...
var _user$project$Triage$get = function (token) {
	return A2(
		...
		A2(
			_evancz$elm_http$Http$fromJson,
			_user$project$Link$decodeLinks,
			A4(_user$project$Triage$authed, 'GET', token, 'http://localhost:8080/links', _evancz$elm_http$Http$empty)),
		function (dict) {
			return _elm_lang$core$Task$succeed(
				_elm_lang$core$Dict$values(dict));
		});
};
var _user$project$Triage$delete = F2(
	function (token, links) {
		return A2(
			_elm_lang$core$Task$onError,
			A4(
				_user$project$Triage$authed,
				'DELETE',
				token,
				'http://localhost:8080/links',
				_evancz$elm_http$Http$string(
					_user$project$Link$encodeLinks(links))),
			function (err) {
				return _elm_lang$core$Native_Utils.crash(
					...
					A2(
						_elm_lang$core$Basics$always,
						'Error!',
						A2(_elm_lang$core$Debug$log, 'Error: ', err)));
			});
	});
var _user$project$Triage$takeSnapshot = F3(
	function (page, n, links) {
		return A2(
			_elm_lang$core$List$take,
			10,
			A2(_elm_lang$core$List$drop, (page - 1) * 10, links));
	});
var _user$project$Triage$stats = function (model) {
	var deleted = _elm_lang$core$List$length(model.deleted);
	var total = _elm_lang$core$List$length(model.links);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('stats__summary')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									' of ',
									_elm_lang$core$Basics$toString((total / model.perPage) | 0))))),
						_elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							' (',
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('stats__progress')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(deleted),
							' deleted'))
					]))
			]));
};
var _user$project$Triage$emptyModel = function (token) {
	return {
		links: _elm_lang$core$Native_List.fromArray(
			[]),
		snapshot: _user$project$Selector$initialModel(
			_elm_lang$core$Native_List.fromArray(
				[])),
		page: 1,
		perPage: 10,
		deleted: _elm_lang$core$Native_List.fromArray(
			[]),
		token: A2(_elm_lang$core$Debug$log, 'token', token),
		done: false
	};
};
var _user$project$Triage$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {links: a, snapshot: b, page: c, perPage: d, deleted: e, token: f, done: g};
	});
var _user$project$Triage$HttpError = function (a) {
...
var _user$project$Triage$doRefresh = function (token) {
	return A3(
		...
		function (_p0) {
			return _user$project$Triage$HttpError(
...
var _user$project$Triage$init = function (flags) {
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$Triage$emptyModel(flags.token),
		_1: cmd
	};
};
	...
	return _elm_lang$core$Native_Utils.eq(model.token, _elm_lang$core$Maybe$Nothing) ? A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('You are not logged!')
					])),
				A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$href('http://localhost:8080/oauth/request')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Login to continue')
					]))
			])) : (model.done ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Well done! No more work right now.')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toString(
									_elm_lang$core$List$length(model.deleted)),
								' items')))
					]))
			])) : (_elm_lang$core$List$isEmpty(model.links) ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('container')
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Triage$stats(model),
				A2(
...
var _user$project$Triage$keyboard = function () {
	var keyToMsg = function (key) {
		return _elm_lang$core$Native_Utils.eq(key, 13) ? _user$project$Triage$Next : _user$project$Triage$Link(
			_user$project$Selector$keyToMsg(key));
	};
	return _elm_lang$keyboard$Keyboard$presses(keyToMsg);
}();
var _user$project$Triage$subscriptions = function (model) {
	return _user$project$Triage$keyboard;
};
var _user$project$Triage$NoOp = {ctor: 'NoOp'};
var _user$project$Triage$doDelete = F2(
	function (token, links) {
		return A3(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$always(_user$project$Triage$NoOp),
			_elm_lang$core$Basics$always(_user$project$Triage$NoOp),
			A2(_user$project$Triage$delete, token, links));
	});
var _user$project$Triage$update = F2(
	function (action, model) {
		var _p2 = action;
		switch (_p2.ctor) {
			case 'Next':
				var toDelete = function (_p3) {
					var _p4 = _p3;
					var _p5 = _p4._1;
					return (_p5.keep || _p5.favorite) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p5);
				};
				var deleted = A2(_elm_lang$core$List$filterMap, toDelete, model.snapshot.links);
				var cmd = function () {
					var _p6 = model.token;
					if (_p6.ctor === 'Nothing') {
						return _elm_lang$core$Platform_Cmd$none;
						...
						return _elm_lang$core$Platform_Cmd$batch(
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Triage$doDelete, _p6._0, deleted),
									_user$project$Ports$deletedLinks(deleted)
								]));
					}
				}();
				var page = model.page + 1;
				var snapshot = _user$project$Selector$initialModel(
					A3(_user$project$Triage$takeSnapshot, page, model.perPage, model.links));
				return _elm_lang$core$List$isEmpty(snapshot.links) ? {
					ctor: '_Tuple2',
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							snapshot: snapshot,
							page: page,
							deleted: A2(_elm_lang$core$Basics_ops['++'], model.deleted, deleted)
						}),
					_1: cmd
				};
			case 'Link':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							snapshot: A2(_user$project$Selector$update, _p2._0, model.snapshot)
						}),
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							links: _p7,
							snapshot: _user$project$Selector$initialModel(
								A3(_user$project$Triage$takeSnapshot, model.page, model.perPage, _p7)),
							done: _elm_lang$core$List$isEmpty(_p7)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HttpError':
				return {
					...
					_0: A2(
						...
						A2(_elm_lang$core$Debug$log, 'error', _p2._0)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Triage$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{init: _user$project$Triage$init, view: _user$project$Triage$view, update: _user$project$Triage$update, subscriptions: _user$project$Triage$subscriptions}),
	flags: A2(
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Triage'], 'Triage', typeof _user$project$Triage$main === 'undefined' ? null : _user$project$Triage$main);
